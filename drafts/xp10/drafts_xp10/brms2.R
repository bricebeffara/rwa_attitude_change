...
equi_test(spread_resp_uspos, rope = c(-0.2, 0.2))
...
equi_test(spread_resp_usneg, rope = c(-0.2, 0.2))
...
equi_test(spread_resp_uspos_dir, rope = c(-0.2, 0.2))
...
equi_test(spread_resp_uspos_ind, rope = c(-0.2, 0.2))
