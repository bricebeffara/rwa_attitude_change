...
# !!orginally!! conditioned stimuli with !!negative!! valence
marg_n <- marginal_effects(spread_resp, effects = "RWAscore:spreading", 
                            conditions = cond_n, method = c("fitted"), # here his where we specify the combination
                            re_formula = NULL,
                            spaghetti = TRUE, nsamples = 500)

# !!orginally!! conditioned stimuli with !!positive!! valence
marg_p <- marginal_effects(spread_resp, effects = "RWAscore:spreading", 
...
attr(marg_n$`RWAscore:spreading`, "spaghetti") <- attr(marg_n$`RWAscore:spreading`, "spaghetti")[grepl(0.5, attr(marg_n$`RWAscore:spreading`, "spaghetti")$sample__),]

attr(marg_p$`RWAscore:spreading`, "spaghetti") <- attr(marg_p$`RWAscore:spreading`, "spaghetti")[grepl(0.5, attr(marg_p$`RWAscore:spreading`, "spaghetti")$sample__),]

attr(marg_n$`RWAscore:spreading`, "spaghetti")$spreading <- ifelse (attr(marg_n$`RWAscore:spreading`, "spaghetti")$spreading == -0.5, "Niveau 1", "Niveau 2")

attr(marg_p$`RWAscore:spreading`, "spaghetti")$spreading <- ifelse (attr(marg_p$`RWAscore:spreading`, "spaghetti")$spreading == -0.5, "Niveau 1", "Niveau 2")
