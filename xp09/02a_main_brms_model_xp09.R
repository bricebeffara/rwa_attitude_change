...
# and warn : load (0.5) vs. no load (-0.5)
#
...
rrwa <- round(max ( load_df$RWAscore) - min ( load_df$RWAscore))
...
# test with rope
equi_gen_xp09_rwa <- equi_test(load_resp, rope = roperwaN)
equi_gen_xp09_rwa <- equi_gen_xp09_rwa[c(11,13:15),]
equi_gen_xp09_rwa$ROPE <- roperwaC

equi_gen_xp09_0.5 <- equi_test(load_resp, rope = c(-0.5, 0.5))
equi_gen_xp09_0.5 <- equi_gen_xp09_0.5[c(9,10,12),]
...
# See 02b_decint2_brms_models_xp09.R for other models 