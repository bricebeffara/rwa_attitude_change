...
base_df$Valence <- ifelse (base_df$usvalence == -0.5, "Négative", "Positive")
...
# data_plot
# ggsave("plots/data_xp01_french.jpg", width = 25, height = 15, units = "cm")
# ggsave("plots/data_xp01_french.pdf", width = 25, height = 15, units = "cm")
# ggsave("plots/data_xp01_french.tex", width = 25, height = 15, units = "cm")
...
# uncomment to display and save plot
# data_spag_all
# ggsave("plots/data_spag_xp01_french.jpg", width = 50, height = 15, units = "cm")
# ggsave("plots/data_spag_xp01_french.pdf", width = 50, height = 15, units = "cm")
# ggsave("plots/data_spag_xp01_french.tex", width = 50, height = 15, units = "cm")
