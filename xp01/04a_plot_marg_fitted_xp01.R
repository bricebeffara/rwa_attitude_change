...
# marg_all
# ggsave("plots/marg_xp01_french.jpg", width = 50, height = 15, units = "cm")
# ggsave("plots/marg_xp01_french.pdf", width = 50, height = 15, units = "cm")
# ggsave("plots/marg_xp01_french.tex", width = 50, height = 15, units = "cm")
