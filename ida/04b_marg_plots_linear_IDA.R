...
marg_ida <- marginal_effects(ida_resp, effects = "RWAscore:usvalence", 
...
attr(marg_ida$`RWAscore:usvalence`, "spaghetti") <- attr(marg_ida$`RWAscore:usvalence`, "spaghetti")[grepl(0.5, attr(marg_ida$`RWAscore:usvalence`, "spaghetti")$sample__),]

attr(marg_ida$`RWAscore:usvalence`, "spaghetti")$usvalence <- ifelse (attr(marg_ida$`RWAscore:usvalence`, "spaghetti")$usvalence == -0.5, "Négative", "Positive")

#
marg_plot = plot(marg_ida, plot = FALSE, mean = F)[[1]] + # here his where we specify the marginal effects of interest
