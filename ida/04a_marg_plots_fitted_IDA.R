...
# !!negative!! valence
marg_neg <- marginal_effects(ida_resp, effects = "RWAscore", ordinal = TRUE, 
                             conditions = cond_neg, method = c("fitted"), # here his where we specify the combination
                             re_formula = NULL)

# !!positive!! valence
marg_pos <- marginal_effects(ida_resp, effects = "RWAscore", ordinal = TRUE, 
...
# marg_all
# ggsave("plots/marg_IDA_french.jpg", width = 50, height = 15, units = "cm")
# ggsave("plots/marg_IDA_french.pdf", width = 50, height = 15, units = "cm")
# ggsave("plots/marg_IDA_french.tex", width = 50, height = 15, units = "cm")
