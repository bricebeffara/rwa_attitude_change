...
rrwa <- round(max ( warn_df$RWAscore) - min ( warn_df$RWAscore))
...
# test with rope
equi_gen_xp11_rwa <- equi_test(warn_resp, rope = roperwaN)
equi_gen_xp11_rwa <- equi_gen_xp11_rwa[c(11,13:15),]
equi_gen_xp11_rwa$ROPE <- roperwaC

equi_gen_xp11_0.5 <- equi_test(warn_resp, rope = c(-0.5, 0.5))
equi_gen_xp11_0.5 <- equi_gen_xp11_0.5[c(9,10,12),]
...
# See 02b_decint2_brms_models_xp11.R for other models 